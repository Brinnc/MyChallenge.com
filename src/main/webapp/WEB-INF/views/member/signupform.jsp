...
form .signup__btn {
	...
	font-size: 14px;
	font-family: "Montserrat", sans-serif;
	box-shadow: 0 15px 30px rgba(0, 0, 128, 0.36);
	transition: 0.2s linear;
}

form .signup__btn:hover {
	box-shadow: 0 0 0 rgba(0, 0, 128, 0);
}
...
<body translate="no">
	<div class="container">
		...
		<form action="/member/signup" method="post" id="joinform">
			...
			<div class="input__check">
				...
				<a style="color: #0000CD" onclick="agree()">*Terms of Service👁️‍🗨️</a>
			</div>
	...
	function agree() {
		window. open('/member/agree', '약관', 'width=1200px,height=500px,scrollbars=yes');
	}

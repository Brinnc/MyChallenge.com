...
<title>Challenge.com - Sign-in</title>
...
<body translate="no">
	<div class="container">
		...
		<button class="kakao__btn" onclick="kakaoLogin();">
			<i class="fa fa-kakao"></i> <a id="kakao" class="kakao"
				href="https://kauth.kakao.com/oauth/authorize?client_id=4810cddbaf8672514af376f814d91cba&redirect_uri=http://localhost:7777/challenges/main&response_type=code">
  ...
  -->
	...
	<script id="rendered-js">
		//----------- kakao --------------------
		function searchID(){
			window.open("http://localhost:7777/member/forgetform", "_blank", "width=500, height=1000", "top=500", "left=500");
		}
